...
const ROLES = [
  { value: 'particulier',  label: 'Particulier',     icon: '👤', desc: 'Je cherche un professionnel IT' },
  { value: 'entreprise',   label: 'Entreprise',       icon: '🏢', desc: 'Je gère des prestataires IT' },
  { value: 'professionnel',label: 'Professionnel IT', icon: '💻', desc: 'Je propose mes services IT' },
]
    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <div className={styles.card}>
          ...
          <p className={styles.subtitle}>Rejoignez des centaines d'utilisateurs sur ITConnect.</p>
