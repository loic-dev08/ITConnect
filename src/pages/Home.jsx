...
export default function Home() {
  ...
  return (
    <div className={styles.page}>
      ...
      {/* ── HERO ── */}
      <section className={styles.hero} aria-label="Présentation ITConnect">
        {/* Halo décoratif */}
        ...
        <div className={styles.heroInner}>
          ...
          <div className={styles.heroText}>
            <span className={styles.eyebrow}>Plateforme de mise en relation IT</span>
            <h1 className={styles.h1}>
              Connectez-vous aux<br />
              <span className={styles.h1Accent}>meilleurs experts IT</span><br />
              près de chez vous
            </h1>
            ...
            {/* Barre de recherche */}
            <form onSubmit={handleSearch} className={styles.searchForm} role="search" aria-label="Rechercher un professionnel IT">
      ...
      <section className={styles.ctaSection} aria-label="Appel à l'action">
        <div className={styles.sectionInner}>
          ...
          <p className={`${styles.h2Sub} ${styles.ctaSectionSub}`}>Rejoignez des centaines d'utilisateurs qui font confiance à ITConnect</p>
          <div className={styles.centre}>
